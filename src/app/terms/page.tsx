      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
        ...
        <section className="space-y-6 text-sm text-white/70 leading-relaxed">
          <div>
            ...
            <p>
              By accessing and using AgentFlow, you agree to these Terms of Service.
          ...
          <div>
            ...
            <p>
              You are responsible for your account and for all activities conducted under your account.
              You agree not to misuse the service or attempt to disrupt it.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              You must ensure that any content you upload or generate using AgentFlow complies with applicable laws.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              AgentFlow is provided “as is”. To the maximum extent permitted by law, AgentFlow will not be liable
